...
public class FolderPickerActivity extends Activity implements OnItemClickListener, OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitle(mAcceptFiles? R.string.pick_file : R.string.pick_folder);
...
//		mFolders.setLayoutAnimation(controller);
	...
	public void onClick(View v) {
		if (v == mOkButton) {
			Uri data = null;
			if (!mAcceptFiles) {
				data = Uri.fromFile(mPath);
			} else {
				if (mFilePath != null) {
					data = Uri.fromFile(mFilePath);
				} else {
					Toast.makeText(getApplicationContext(), R.string.file_not_selected, Toast.LENGTH_SHORT).show();
					return;
				}
			}
	...
	class FolderAdapter extends BaseAdapter {
		...
		LayoutInflater mInflater = LayoutInflater.from(FolderPickerActivity.this);
